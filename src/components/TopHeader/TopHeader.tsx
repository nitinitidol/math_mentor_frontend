          ...
          <div className="container-fluid">
            ...
            <div className="top-right-menu">
              ...
              >
                ...
                <MenuItem className="notify-items" onClick={handleCloseNotify}>
                  <p className="notify-items-text">
                    Your new leaning exercise was ready to start.
                  </p>
                  <p className="notify-items-time">2 min ago</p>
              ...
              >
                <div className="user-setting-head">
                  ...
                  <div className="user-setting-content">
                    ...
                    <div className="user-email">sarah.anderson@example.com</div>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <path
                    d="M4.40002 4.80078H20.6V6.60078H4.40002V4.80078ZM4.40002 11.1008H20.6V12.9008H4.40002V11.1008ZM4.40002 17.4008H20.6V19.2008H4.40002V17.4008Z"
                    fill="#0A0D14"
                  />
                </svg>
              </Link>
