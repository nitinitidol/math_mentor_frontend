...
import { Autocomplete, IconButton, InputAdornment, ListItem, ListItemText, TextField } from "@mui/material";
...
const validationSchema = Yup.object({
  ...
  grade: Yup.number().required("Grade is required").nullable().typeError("Grade must be a number"),
      ...
      onSubmit: (values, action) => {
        ...
        dispatch(signUpPostCall(values)).unwrap().then((response)=>{
          if(response.status){
            ...
            dispatch(openSnackbar({message : response.message || "Error in signing the user" , severity : "error"}))
          }
          ...
          <div className="col-md-6 p-0">
            <div className="auth-form-block">
              <div className="auth-form-content-block">
                ...
                <p className="content-dsc-text">Your AI-powered learning companion</p>
                <form onSubmit={handleSubmit} className="w-100">
                  ...
                  <div className="input-form-field-wrapper">
                    <Autocomplete
                      ...
                      value={
                        values.grade
                          ? selectGrade.find((option) => handleGradeChange(option.label) === values.grade)
                          : null
                      }
                      onChange={(_, newValue) => {
